...
insert into sales values ('S06', 'rupertd@yahoo.ca', 'X01', date('now', '-2 days'), 'brand new xbox xbox one s', 'Brand new', 399.99);
insert into sales values ('S07', 'ibev@gmail.com', 'X02', '2020-02-20', 'xBox xbox xbox 360 signed by bungie', 'New', 900.00);
